defmodule CollaborativeEditorWeb.ConnCase do
  @moduledoc """
  ...
  the SQL sandbox, so changes do not persist between tests. If you are
  using PostgreSQL, you can even run database tests asynchronously
  by setting `use CollaborativeEditorWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import CollaborativeEditorWeb.ConnCase
    end
  end
